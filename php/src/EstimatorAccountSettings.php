...
$stmt = $mysqli->prepare("SELECT userID, Firstname, Lastname, Username, Email FROM Users WHERE userID=23");
$stmt->execute();
...
if(isset($_GET))
{
    $sqli = "SELECT Firstname, Lastname, Username, Email FROM Users WHERE userID=23";
...
if(isset($_POST['btn-update']))
{
    ...
    $Email = $_POST['Email'];
    $update = "UPDATE Users SET Firstname='$Firstname', Lastname='$Lastname', Username='$Username', Email='$Email' WHERE userID=23";
...
<head>
    ...
    <link rel="stylesheet" href="EstimatorAccountSettings.css" type="text/css">
